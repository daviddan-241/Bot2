...
- [Render better-sqlite3 fix](render-sqlite3.md) — .npmrc with better_sqlite3_build_from_source=false prevents OOM crash; server/src/app.js already serves client/dist in production.
